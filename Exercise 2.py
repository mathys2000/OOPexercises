...
class Oscilloscope:
    ...
    def __init__(self, fs, voltage_scale=[-1, 1], time_scale=[-0.1, 0.1], 
                 current_signal=None):
        self.fs = fs
        self.voltage_scale = voltage_scale
        self.time_scale = time_scale
        self.time = np.arange(int(fs*time_scale[0]), int(fs*time_scale[1]))/self.fs
...
# **Answers:**
#
# 1. fs, voltage_scale, time_scale, current_signal_orig
# 2. current_signal
# 3. They have different states and different method arguments
